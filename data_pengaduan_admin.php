          ...
          while ($r = mysqli_fetch_array($tp)) {
            ...
            <tr>
              ...
              <td style="align-items: center">
                <a href="edit_status_pengaduan.php?id=<?php echo $r['ID_PENGADUAN']; ?>"> UBAH STATUS </a>
                <br>
                <br>
                <a href="hapus_pelanggan.php?id=<?php echo $r['ID_PELANGGAN']; ?>"  onclick="return confirm('Yakin Hapus?')"> HAPUS PENGADUAN </a>
              </td>
            </tr>
            <?php $i = $i + 1; ?>
          <?php } ?>
